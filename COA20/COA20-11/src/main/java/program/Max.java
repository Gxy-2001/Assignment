...
public class Max {
    ...
    static String h = File.separator;
    private static final String MAX_PROGRAM_PATH = "src" + h + "main" + h + "resources" + h + "max.txt";
    ...
    public int max(int a, int b) {
        ...
        //instrA和instrB是对A和B赋值
        //调用 MOV 0xC7
        ALU alu = new ALU();
        String instrA = "1100011110000011" + zero + t.intToBinary(String.valueOf(a));
        //String instrB = "1100011110000011" + alu.add(zero, t.intToBinary(String.valueOf(instrA.length()))) + t.intToBinary(String.valueOf(b));
        String instrB = "1100011110000011" + "00000000000000000000000000100000" + t.intToBinary(String.valueOf(b));
        // 加载max.txt并执行你的二进制代码
        try {
